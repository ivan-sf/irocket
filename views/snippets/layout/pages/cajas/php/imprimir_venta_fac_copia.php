...
$dataFecha = mysqli_fetch_array($array2);
$dateRegister = $dataFecha['dateRegister'];
if($rowdata!=0){
//LOGOTIPO
...
$printer->text("FECHA " . $dateRegister . "\n");
...
print "<script>window.location='".  URL ."facturas/detalles&id=$id&detalles';</script>";
