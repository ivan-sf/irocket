...
$q2 = $con->query("INSERT INTO `billreports` (`bills_idbills`, `total`, `pago`, `saldo`, `cliente`, `empleado`, `caja`, `fecha`, `estado`, `typeBill`) VALUES ('$cart_id', '$total', '$pago', '$saldo', '$cliente', '1', '$cash', '$dateTime', '1', 'Compra')");
