...
<thead>
      ...
      <tbody>
          ...
          <td width="100px">
          <?php echo strtolower($r->nameProduct); ?> <?php echo strtolower($r->laboratorio); ?>
          </td>
              ...
              <input type="hidden" name="quantityProduct" value="<?php echo $r->quantityProduct; ?>">
            ...
            <td>
              ...
              <input type="hidden" name='precioCompra' value="<?php echo $r->price_buy; ?>">
              ...
              <?php if($r->precio_promotion2!=''){  ?>
              <option value="<?php echo $r->precio_promotion2 ?>">
              <?php echo number_format($r->precio_promotion2) ?>
              </option>
              <?php }  ?>
