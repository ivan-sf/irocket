    ...
    <div class="white-box">
      <div class="el-card-item">
        ...
        <div class="el-card-content">
          ...
          <span class="pro-price bg-success"><small><small><?php echo number_format($r->precio); ?></small></small></span><br>
          <span class="pro-price bg-danger"><small><small><?php echo number_format($r->precio_promotion); ?></small></small></span>
          <?php }elseif ($r->precio_promotion != $r->precio) { ?>
          <span class="pro-price bg-success"><small><small><?php echo number_format($r->precio); ?></small></small></span><br>
          <span class="pro-price bg-primary"><small><small><?php echo number_format($r->precio_promotion); ?></small></small></span>
          <?php } ?>
          ...
          if ($r->precio_promotion == $r->precio) {
           ...
           echo "<p class='text-'><b>Prom:</b> ".$codeProductP. "</p><br>";
