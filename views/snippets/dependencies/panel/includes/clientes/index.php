        ...
        <div class="container-fluid">
            ...
            <div class="row bg-title">
                ...
                <br>
                    ...
                    Se editaron los datos de tu cliente correctamente puedes ver el resultado acontinuacion.
                    ...
                    El cliente al que intentas acceder no existe o ha sido eliminado.
                ...
                <div class="col-lg-12">
                    ...
                    if ($row <= 0) { ?>
                         <center>
                        <h4><b>No se encontraron clientes activos.</b></h4>
                         <button class="btn m-btn--pill btn-success"><a class="text-white" href="<?php echo URL; ?>clientes/crear">Crear clientes</a></button>
                         </center>
                     <?php }else{ ?>
                        <div class="row">
                            <div class="col-lg-12">
...
{
    $.ajax({
        url : 'models/search/clientes.php',
        type : 'POST',
        dataType : 'html',
