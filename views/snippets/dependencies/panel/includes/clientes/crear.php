...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<button class="btn m-btn--pill btn-badge" type="submit"><a href="<?php echo URL; ?>clientes?catalogo" class="">Catalogo</a></button>
		...
		<div class="white-box">
			<center><h3 class="box-title">Crear clientes</h3></center>
			<div class="row">
				...
				<div class="col-sm-12">
					<div id="slimtest1">
						<div class="m-grid__item m-grid__item--fluid m-wrapper">
							...
							<center><b><small>Puedes agregar hasta 5 clientes al sistema en cada consulta, para ampliar tu paquete de consultas visita  <a  target="_blank" href=" <?php echo URL_SITIO; ?> ">nuestro sitio web.</a></small></b><br><br>
								...
								<form method="POST" enctype="multipart/form-data" id="formulario" onsubmit="return checkSubmit();">
									<div class="m-portlet__body">
													...
													<div class="col-lg-12">
														...
														<div class="col-lg-12">
															<?php if (isset($_GET['success'])) {
																...
																Los datos se han registrado correctamente, puedes ver el resultado en la tabla y/o el catalogo de clientes si tiene dudas o problemas contactenos por medio de <a target='_blank' href='<?php URL_SITIO ?> '>nuestro sitio web.</a>
																</div>
																<div class='m-alert__close'>
																<button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>
																</div>
												...
												<div class="col-lg-12">
													<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
														...
														<span class="m-form__help"><br>
															<small>Por favor seleccione la empresa al que desea agregar el cliente y/o clientes</small>
														</span></center>
													...
													<div class="col-lg-12">
														...
														<div class="col-lg-12">
															...
															<span class="m-form__help">
																<small><b>Primer apellido</b> del cliente.</small>
															</span>
														...
														<div class="col-lg-12">
															...
															<span class="m-form__help"><br>
																<small>Documento del cliente.</b></small>
															</span>
														...
														<div class="col-lg-12">
															...
															<span class="m-form__help"><br>
																<small>Empresa a la cual pertenece el cliente</small>
										...
										<div class="col-lg-12">
											...
											<span class="m-form__help">
												<small>Fecha de nacimiento del cliente. </small>
											</span>
										...
										<div class="col-lg-12">
											...
											<span class="m-form__help"><br>
												<small>Email de contacto del cliente</small>
									...
									<div class="col-lg-12">
										<div class="col-lg-12">
											...
											<span class="m-form__help"><br>
												<small>Ingrese una descripcion o dato que desee guardar del cliente.</small>
											</span>
									...
									<div class="col-lg-12">
										<div class="col-lg-12">
											...
											<span class="m-form__help"><br>
												<small>Ingrese una foto para identificar el cliente.</small>
											</span>
								...
								<div class="col-lg-12">
												...
												<br><center><button type="button" class="btn btn-block m-btn--square  btn-success m-btn m-btn--custom m-btn--bolder m-btn--uppercase" id="botonCrear">
													<h4 class="text-white">Crear cliente(es)</h4>
												</button></center><br>
											</div>
