...
var table = $("#dt_contabilidad").DataTable({
    "ajax":{
        "method":"GET",
        "url": "../../irocket/views/tables/contabilidad/listar_documentos.php",
        "data": {
    ...
    columns:[
        ...
        {"data":"totalCredito"},
        {
            ...
            "render": function ( data, type, full, meta ) {
                var comprobante = ""+full.comprobante;
                var tipo = ""+full.tipoNotacontable;
                return '<a href='+'http://192.168.1.113/irocket/contabilidad/ver?tipo=documento&numero='+comprobante+'&comprobante='+tipo+' class="btn btn-info rolloverBtn" role="button">Ver</a>';
            }
        },
        {
            sortable: false,
            "render": function ( data, type, full, meta ) {
                var comprobante = ""+full.comprobante;
                var tipo = ""+full.tipoNotacontable;
                return '<a href='+'http://192.168.1.113/irocket/contabilidad/editar?tipo=documento&numero='+comprobante+'&comprobante='+tipo+' class="btn btn-warning rolloverBtn" role="button">Editar</a>';
            }
        },
        {
            sortable: false,
            "render": function ( data, type, full, meta ) {
                var comprobante = ""+full.comprobante;
                var tipo = ""+full.tipoNotacontable;
                return '<a href='+'http://192.168.1.113/irocket/contabilidad/eliminar?tipo=documento&numero='+comprobante+'&comprobante='+tipo+' class="btn btn-danger rolloverBtn" role="button">Eliminar</a>';
            }
        }
