...
$arrayProducts = $modelProducts->arrayProvider();
 ?>
        ...
        <div class="container-fluid">
            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <button class="btn m-btn--pill btn-badge"><a href="<?php echo URL; ?>proveedores/crear">Crear</a></button><br>
                <br>
                    ...
                    Se editaron los datos de tu proveedor correctamente puedes ver el resultado acontinuacion.
                    ...
                    El proveedor al que intentas acceder no existe o ha sido eliminado.
                ...
                <div class="col-lg-12">
                    ...
                    if ($row <= 0) { ?>
                         <center>
                        <h4><b>No se encontraron proveedores activos.</b></h4>
                         <button class="btn m-btn--pill btn-success"><a class="text-white" href="<?php echo URL; ?>proveedores/crear">Crear proveedores</a></button>
                         </center>
                     <?php }else{ ?>
                        <div class="row">
                            <div class="col-lg-12">
...
{
    $.ajax({
        url : 'models/search/proveedores.php',
        type : 'POST',
        dataType : 'html',
