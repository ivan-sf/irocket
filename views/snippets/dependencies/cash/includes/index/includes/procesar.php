...
$sql = $con->query("SELECT * FROM bills
WHERE users_idusers = $iduser AND stateBill=2  AND typeBill=1");
...
?>
<?php 
if($iduser==3 OR $iduser==4 OR $iduser==5 OR $iduser==6770){
    $color = "primary";
}else{
    $color = "success";
}
...
<div class="col-lg-12">
    ...
    El producto <b><?php echo $_GET['producto']; ?></b> esta agotado.
    </div>
    </div>
<?php
}
