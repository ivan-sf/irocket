        ...
        <div class="white-box">
            <div class="product-img">
                ...
                <div class="pro-img-overlay">
                    <a href="<?php echo URL; ?>proveedores/detalles?id=<?php echo $r->idusers; ?>&configurar" class="bg-warning"><i class="ti-marker-alt"></i></a> 
                    <a href="<?php echo URL; ?>proveedores/detalles?id=<?php echo $r->idusers; ?>&eliminar" class="bg-danger"><i class="ti-trash"></i></a>
                </div>
            </div>
